    ...
    <section className="lms-page-shell">
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              ...
              <p className="lms-section-description">
                Scan the SePay QR code or transfer manually. The Vera Voice checks payment confirmation every few seconds.
              </p>
            </div>
          </div>
        </div>
      ...
      {purchase.status === 'PAID' && purchase.enrollmentId ? (
        ...
        <div className="lms-surface border-emerald-200 bg-emerald-50 p-5">
          ...
          <p className="mt-1 text-sm text-emerald-800">The Vera Voice is preparing your enrollment. Refresh this page if the course button does not appear yet.</p>
        </div>
      ) : null}
    </section>
  )
