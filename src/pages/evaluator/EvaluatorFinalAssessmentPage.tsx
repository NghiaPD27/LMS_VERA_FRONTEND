    ...
    <article className="lms-surface overflow-hidden">
      <div className="border-b border-border bg-slate-900/80 p-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-wider text-primary">Final assessment</p>
          ...
          <div className="text-xs text-muted-foreground lg:text-right">
            ...
            {showDetailLink && session.id && (
              <Link className="mt-1 block font-bold text-primary hover:underline" to={`/evaluator/finals/${session.id}`}>
                View detail
              </Link>
            )}
          </div>
